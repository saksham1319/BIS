...
function buildReport(standard: Standard, generatedOn: string): string {
    ...
    lines.push(`**Generated:** ${generatedOn} by BIS Sathi`);
    ...
    lines.push(`---`);
    lines.push("");
    lines.push(`Illustrative demo data — verify against official BIS sources before making a compliance decision. This document was generated by BIS Sathi, a demonstration assistant, and is not a BIS publication.`);
    lines.push("");
...
export function ReportsView() {
    const [selectedId, setSelectedId] = useState(allStandards[0]?.id ?? "");
